...
import awsPartner from "@/assets/aws-partner.jpg";
import zohoAffiliate from "@/assets/zoho-affiliate.png";
          ...
          <div className="relative z-10 container mx-auto px-6 pt-32 pb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                {/* Zoho Affiliate Badge (below AWS) */}
                <div className="mb-8">
                  <img
                    src={zohoAffiliate}
                    alt="Zoho Affiliate"
                    className="h-28 md:h-36 object-contain rounded-xl"
                  />
                </div>

                <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold text-foreground mb-2 animate-fade-in-up tracking-tight leading-tight">
                  Connecting<br />
                  <span className="text-primary">opportunity</span>
                </h1>

                <p className="font-subheading text-lg md:text-xl text-primary font-medium mb-4 animate-fade-in-up tracking-wide uppercase" style={{ animationDelay: "0.15s" }}>
                  Your Digital Inclusion Enablement Partner
                </p>

                <p className="max-w-xl text-base md:text-lg text-foreground/70 font-body font-light mb-10 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: "0.45s" }}>
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-lg border border-primary/40 px-8 py-4 font-subheading text-sm font-semibold transition-colors duration-300 hover:bg-primary/10 gap-2"
                    style={{ color: "#25D366" }}
                  >
              ...
              <div className="relative flex items-center justify-center">
                <div className="w-full aspect-[4/5] max-w-lg bg-muted/30 border-2 border-dashed border-primary/20 rounded-2xl flex items-center justify-center">
                  <span className="font-body text-sm text-muted-foreground">Image Placeholder</span>
                </div>
              </div>
            </div>
          </div>
