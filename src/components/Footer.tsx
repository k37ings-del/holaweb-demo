        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="https://www.facebook.com/holaweb.africa/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors" aria-label="Facebook"><Facebook className="h-5 w-5" /></a>
