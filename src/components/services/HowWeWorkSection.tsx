    ...
    <section className="py-24 relative">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden lg:block absolute top-12 left-[12%] right-[12%] h-px bg-golden/20" />
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="w-24 h-24 mx-auto rounded-full border-2 border-golden/30 bg-card flex items-center justify-center mb-5 relative z-10">
                <s.icon className="w-10 h-10 text-cherry" />
              </div>
              <span className="text-golden text-xs font-noto uppercase tracking-widest mb-1 block">
                {s.step}
              </span>
              <h3 className="font-garet text-xl font-bold text-foreground mb-2">{s.title}</h3>
