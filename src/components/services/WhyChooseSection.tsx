      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((r, i) => (
            ...
            >
              <div className="w-16 h-16 mx-auto rounded-full border-2 border-primary/20 bg-primary/10 flex items-center justify-center mb-5 group-hover:border-primary/50 group-hover:scale-110 transition-all duration-300">
