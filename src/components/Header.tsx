...
const GOOGLE_FORM_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLScjWbZKNcccQRYIBX6oQo-n6vVlJ8UduH3iknn5YQj8xcnDzA/viewform?usp=sharing&ouid=106739550657489478981";
...
const navItems = [
  { label: "Home", href: "/" },
  { label: "SME Impact", href: "https://smeimpact.co.za/", external: true },
      ...
      <div className="bg-secondary border-b border-border">
        <div className="container mx-auto px-6 flex items-center justify-between py-2">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <a href="https://wa.me/27715138219" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-green-500 transition-colors" aria-label="WhatsApp">
        ...
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navItems.map((item) =>
              item.hasDropdown ? (
                ...
                <a
                  ...
                  className="font-subheading text-sm font-medium tracking-wide uppercase text-foreground/80 hover:text-golden transition-colors duration-300"
                >
                  {item.label}
                </a>
              ) : (
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg px-5 py-2.5 font-subheading text-sm font-semibold text-white transition-all duration-300 hover:opacity-90"
        ...
        <div className="md:hidden bg-background border-t border-border">
          <nav className="container mx-auto px-6 py-4 flex flex-col gap-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg px-5 py-2.5 mt-2 font-subheading text-sm font-semibold text-white transition-all duration-300 w-fit"
              style={{ backgroundColor: "#25D366" }}
            >
              <WhatsAppIcon className="h-4 w-4" />
              WhatsApp
