      ...
      <div className="bg-card border-b border-border text-foreground/70 text-xs fixed top-0 left-0 right-0 z-[60]">
        <div className="container mx-auto px-6 flex items-center justify-between h-9">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://www.linkedin.com/in/holaweb-africa/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" aria-label="LinkedIn">
              <Linkedin className="h-4 w-4" />
            </a>
            <a href="https://www.youtube.com/@Holaweb.Africa" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors" aria-label="YouTube">
